...
def go_repositories():
    ...
    go_repository(
        ...
        sum = "h1:SxHSpmz7W+DfQ3MLCa0/npTzrplaVIgg90pycolDgIw=",
        version = "v0.0.0-20190723210415-bf9fd63c33d0",
    )
    ...
    go_repository(
        ...
        sum = "h1:kwa/4M1dbmhZqOIqYiTtbA6JrvPwo1+jqlub2qDXX90=",
        version = "v0.0.0-20190731214159-1e85ed8060aa",
    )
