...
func (o *options) parseOpts() {
	...
	flag.StringSliceVarP(&o.RepoAllowlist, "repo-allowlist", "w", []string{}, "Repositories to allowlist in generation process.")
	flag.StringSliceVarP(&o.RepoDenylist, "repo-denylist", "b", []string{}, "Repositories to denylist in generation process.")
