...
resource "cloudflare_dns_record" "cname_records" {
  for_each = {
    ...
    "aws.prow"      = "k8s-default-tlsing-211de21a28-1671250631.us-west-2.elb.amazonaws.com"
...
# ACM DNS-validation record for the aws.prow.istio.io certificate served by the
# prow control-plane ALB (see infra/aws/istio/acm.tf). The token is generated by
# ACM; refresh from `terraform -chdir=infra/aws/istio output aws_prow_istio_io_certificate_validation`.
resource "cloudflare_dns_record" "aws_prow_acm_validation" {
  zone_id = var.zone_id
  name    = "_41da2f2ba91eff33d4b2e675439c66cf.aws.prow"
  type    = "CNAME"
  ttl     = 300
  content = "_0b51298a950e8712ee56987b89bfc81f.jkddzztszm.acm-validations.aws"
}
