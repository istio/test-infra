...
paths='$AUTOMATOR_REPO_DIR/prow/gcp/cluster/jobs/**/*.yaml,$AUTOMATOR_REPO_DIR/prow/gcp/config/jobs/**/*.yaml,$AUTOMATOR_REPO_DIR/prow/gcp/cluster/cloudflare_rotator_cronjob.yaml'
key="image"
var="IMAGE_VERSION"
