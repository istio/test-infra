...
var (
	...
	inputDir            = flag.String("input-dir", "./prow/gcp/config/jobs", "directory of input jobs")
	outputDir           = flag.String("output-dir", "./prow/gcp/cluster/jobs", "directory of output jobs")
